...
const doSorted = (list, key) => list.sort((a, b) => (
...
describe('DatabaseLib Test', () => {
    ...
    const paginationTestStr = (predicate) => {
        ...
        const db = new DatabaseLib(phoneCallKeyStr);
        db.insert(...content);
    ...
    it('should update values correctly', () => {
        ...
        const idx = Math.floor(content.length / 2);
        const db = new DatabaseLib(phoneCallKeyStr);
